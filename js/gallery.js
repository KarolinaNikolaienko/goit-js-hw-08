...
images.forEach(({ preview, original, description }) => {
    ...
    // linkHTML.href = original;
    // linkHTML.classList.add("gallery-link");
    // const imageHTML = document.createElement("img");
    // imageHTML.src = preview;
    // imageHTML.alt = description;
    // imageHTML.classList.add("gallery-image");
    // imageHTML.dataset.source = original;

    // linkHTML.append(imageHTML);
    // console.log(linkHTML);
    // linkHTML.addEventListener("click", (event) => {
  ...
  <a class="gallery-link" href="${original}" onclick="return false">
    ...
    // imagesHTML += `<li class="gallery-item">` + linkHTML.outerHTML + `</li>`;
});
